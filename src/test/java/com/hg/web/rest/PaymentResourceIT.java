...
class PaymentResourceIT {
    ...
    private static final LocalDate DEFAULT_EXTENDED_DATE = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_EXTENDED_DATE = LocalDate.now(ZoneId.systemDefault());

    private static final Instant DEFAULT_PAYED_DATE = Instant.ofEpochMilli(0L);
    private static final Instant UPDATED_PAYED_DATE = Instant.now().truncatedTo(ChronoUnit.MILLIS);

    private static final PaymentStatusEnum DEFAULT_STATUS = PaymentStatusEnum.PAYED;
    private static final PaymentStatusEnum UPDATED_STATUS = PaymentStatusEnum.CANCELED;

    private static final Integer DEFAULT_RETRY = 1;
    private static final Integer UPDATED_RETRY = 2;
    ...
    public static Payment createEntity(EntityManager em) {
        Payment payment = new Payment()
            ...
            .extendedDate(DEFAULT_EXTENDED_DATE)
    ...
    public static Payment createUpdatedEntity(EntityManager em) {
        Payment payment = new Payment()
            ...
            .extendedDate(UPDATED_EXTENDED_DATE)
    ...
    void getAllPayments() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.[*].extendedDate").value(hasItem(DEFAULT_EXTENDED_DATE.toString())))
            .andExpect(jsonPath("$.[*].payedDate").value(hasItem(DEFAULT_PAYED_DATE.toString())))
    ...
    void getPayment() throws Exception {
        ...
        restPaymentMockMvc
            ...
            .andExpect(jsonPath("$.extendedDate").value(DEFAULT_EXTENDED_DATE.toString()))
            .andExpect(jsonPath("$.payedDate").value(DEFAULT_PAYED_DATE.toString()))
